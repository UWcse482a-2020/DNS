...
(15 points) (5) Your project development. You can use the project plan as a resource (use cases, storyboard, what tools you used to build, how you built, what algorithms you chose) is explained verbally and pictorially in lay terms.
Tools used:
Node js
